...
export default function BottomNav() {
  ...
  return (
    ...
    <nav className="md:hidden fixed bottom-6 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] max-w-md z-50 h-16 rounded-full bg-white/90 dark:bg-card/90 backdrop-blur-md shadow-lg border border-slate-300 dark:border-border">
