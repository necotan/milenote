        ...
        <CardContent className="p-3.5 flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-0.5 leading-tight text-slate-500 dark:text-muted-foreground">
              ...
              <p className="text-lg font-black tracking-wider">{t("home.unrecorded")}</p>
            </div>
      ...
      <CardContent className="p-3.5 flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className={`mt-0.5 leading-tight ${alert.isUrgent ? 'text-red-600' : 'text-slate-800 dark:text-foreground'}`}>
            ...
            <p className="text-lg font-black tracking-wider">{alert.displayValue}<span className="text-[10px] ml-0.5">{alert.isOver ? (alert.isMonthsOnly ? t("common.months_unit") : t("common.km_unit")) + t("home.exceeded") : (alert.isMonthsOnly ? t("common.months_unit") : t("common.km_unit"))}</span></p>
          </div>
